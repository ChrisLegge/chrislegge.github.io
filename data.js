...
const portfolioData = {
    ...
    projects: [
        ...
        },
        {
            ...
            dates: "August 2024",
            summary: "A short description of the animation.",
            details: "More detail about the project here..."
        },
        {
    ...
    // Each entry can be a plain string path, or an object: { src, alt, caption }
    gallery: [
        ...
        { src: "images/gallery/photo4.jpg", caption: "Standing infront of a waterfall in iceland" }
    ],
